...
public class CustomApp extends Application {
    ...
    private static volatile com.tennessee.project_navi.CustomApp instance = null;
        ...
        public IApplicationConfig getApplicationConfig() {
            return new IApplicationConfig() {
                ...
                public Context getApplicationContext() {
                    return com.tennessee.project_navi.CustomApp.getGlobalApplicationContext();
                }
            };
        }
    }

    public static com.tennessee.project_navi.CustomApp getGlobalApplicationContext() {
        if(instance == null) {
